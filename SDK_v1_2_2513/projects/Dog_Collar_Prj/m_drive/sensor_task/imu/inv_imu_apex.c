                                        ...
                                        inv_imu_apex_parameters_t *apex_inputs)
{
	...
	sensor_test_imu_apex_parameters_t imu_apex_parameters_tmp;
	get_sensor_imu_apex_parameters(&imu_apex_parameters_tmp);
	
	apex_inputs->pedo_amp_th          = imu_apex_parameters_tmp.pedo_amp_th;
	apex_inputs->pedo_step_cnt_th     = imu_apex_parameters_tmp.pedo_step_cnt_th;
	apex_inputs->pedo_step_det_th     = imu_apex_parameters_tmp.pedo_step_det_th;
	apex_inputs->pedo_sb_timer_th     = imu_apex_parameters_tmp.pedo_sb_timer_th;
	apex_inputs->pedo_hi_enrgy_th     = imu_apex_parameters_tmp.pedo_hi_enrgy_th;
	apex_inputs->power_save_time      = imu_apex_parameters_tmp.power_save_time;
	apex_inputs->low_energy_amp_th    = imu_apex_parameters_tmp.low_energy_amp_th;
