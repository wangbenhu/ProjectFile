...
typedef struct {
	...
	ConfigTable_t	device_config;
	uint8_t			appControl_voiceId;
	uint8_t			appControl_voiceIndex;
	uint8_t			appControl_lightTime;
	uint8_t 		*appControl_wifiLat;
	uint8_t			*appControl_wifiLon;
	uint8_t 		*appControl_LatType;
	uint8_t			*appControl_LonType;
	uint8_t			*device_wifiLat;
	uint8_t			*device_LatType;
	uint8_t			*device_wifiLon;
	uint8_t			*device_LonType;
