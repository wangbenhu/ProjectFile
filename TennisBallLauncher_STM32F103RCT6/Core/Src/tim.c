...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = HIGH_SPEED_MOTOR2_PWM2_Pin|HIGH_SPEED_MOTOR2_PWM1_Pin|HIGH_SPEED_MOTOR1_PWM2_Pin|HIGH_SPEED_MOTOR1_PWM1_Pin;
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA3     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = LOW_SPEED_MOTOR3_PWM1_Pin|LOW_SPEED_MOTOR3_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = LOW_SPEED_MOTOR2_PWM1_Pin|LOW_SPEED_MOTOR2_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = LOW_SPEED_MOTOR1_PWM1_Pin|LOW_SPEED_MOTOR1_PWM2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
{
  driveInt.flagDown1 = 0;
  driveInt.flagUp1 = 0;
  driveInt.Ton1 = 0;
  driveInt.Toff1 = 0;
  driveInt.TonLast1 = 0;
  driveInt.timer_overflow_count = 0;
...
{
  __HAL_TIM_SetCompare(&htim8, Channel, pwmVal); // �޸ıȽ�ֵ���޸�ռ�ձ�
}
void setLowSpeedMotor2_PWMCompare(uint32_t Channel, uint16_t pwmVal)
{
  __HAL_TIM_SetCompare(&htim3, Channel, pwmVal); // �޸ıȽ�ֵ���޸�ռ�ձ�
}
void setLowSpeedMotor3_PWMCompare(uint32_t Channel, uint16_t pwmVal)
{
  __HAL_TIM_SetCompare(&htim2, Channel, pwmVal); // �޸ıȽ�ֵ���޸�ռ�ձ�
}
void setHighSpeedMotor1_PWMCompare(uint32_t Channel, uint16_t pwmVal)
{
  __HAL_TIM_SetCompare(&htim1, Channel, pwmVal); // �޸ıȽ�ֵ���޸�ռ�ձ�
}
