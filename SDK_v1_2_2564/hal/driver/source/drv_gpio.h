 ...
 *
 * @param[in] om_gpio        Pointer to GPIO
 * @param[in] gpio_mask      GPIO pin mask，use GPIO_MASK(gpio_idx) to generate
 *
 * @return The single GPIO pin direction
 *
 * @note The return value can only reflect the direction of a single pin.
 *
 *******************************************************************************
 */
 ...
 *******************************************************************************
 */
extern void drv_gpio_uninit(OM_GPIO_Type *om_gpio, gpio_mask_t gpio_mask);
