...
/**
  \brief  Typedef of system VCC voltage range enumerate
 */
typedef enum {
    /// VCC supply voltage range: 2.3V ~ max, default value
    AUDIO_SYS_VCC_LEVEL_HIGH = 0x0,
    /// VCC supply voltage range: 1.8V ~ 2.3V
    AUDIO_SYS_VCC_LEVEL_LOW  = 0x1,
    /// NOTE: Audio can not work by VCC voltage lower than 1.8V
} audio_sys_vcc_level_t;
...
/**
 *******************************************************************************
 * @brief Audio set system VCC voltage range
 * @NOTE If need change, you must call it before drv_audio_init
 *******************************************************************************
 */
void drv_audio_set_sys_vcc_level(audio_sys_vcc_level_t level);
