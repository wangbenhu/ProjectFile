...
/**
 *******************************************************************************
 * @brief Abort SPI write transfer
 *
 * @param[in] om_spi   Pointer to SPI
 *
 *******************************************************************************
 */
extern void drv_spi_abort_write(OM_SPI_Type *om_spi);

/**
 *******************************************************************************
 * @brief Abort SPI read transfer
 *
 * @param[in] om_spi   Pointer to SPI
 *
 *******************************************************************************
 */
extern void drv_spi_abort_read(OM_SPI_Type *om_spi);
