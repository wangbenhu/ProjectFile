...
// For OM_MUSB
#define  USB_POWER_VBUSVAL      0x00000040  /*!<set when VBUS > VBUSVAL threshold */
#define  USB_POWER_VBUSSESS     0x00000020  /*!<set when VBUS > VBUSSESS threshold */
#define  USB_POWER_VBUSLO       0x00000010  /*!<set when VBUS > VBUSLO threshold */
#define  USB_POWER_EN_SUSPEND   0x00000001  /*!<set by CPU to enter into Suspend mode when Suspend signaling is recevied in Peripheral mode */
...
#define CONFIG_USBDEV_DMACH_NUM 0
