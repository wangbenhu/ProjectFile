 ...
 */
#if 0
	#define log_sec_debug(...) om_log(OM_LOG_INFO, ##__VA_ARGS__)
#else
	#define log_sec_debug(...)
#endif

#define hexdump(d, l) do{for(int i=0;i<l;i++)log_sec_debug("%02X ", ((uint8_t*)d)[i]);log_sec_debug("\n");}while(0);
