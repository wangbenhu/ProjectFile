...
typedef struct {
     ...
     *                  0x0002: Connection refused 每 PSM not supported.
     *                  0x0003: Connection refused 每 security block.
     *                  0x0004: Connection refused 每 no resources available.
     *                  0x0006: Connection refused 每 invalid Source CID
     *                  0x0007: Connection refused 每 Source CID already allocated
